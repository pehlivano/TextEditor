	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			for(int i=0; i<trials; i++) {
				...
				double fleschScore = basic.getFleschScore();
			}
			long basicEndTime = System.nanoTime();
			double basicDuration = (basicEndTime - basicStartTime) / 1000000000.0;
			System.out.format("%.5f\t",basicDuration);
			
			
			long efficientStartTime = System.nanoTime();
			for(int i=0; i<trials; i++) {
				EfficientDocument efficient = new EfficientDocument(s);
				double fleshScore2 = efficient.getFleschScore();
			}
			long efficientEndTime = System.nanoTime();
			double efficientDuration = (efficientEndTime - efficientStartTime) / 1000000000.0;
